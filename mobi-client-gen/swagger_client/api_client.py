...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.pool = mp.ThreadPool(processes=self.worker_count) # GIL doesn’t have much impact as the lock is shared between threads while they are waiting for I/O
    ...
    def __call_api(
        ...
        # print('response_data: {}'.format(response_data.data))
        # print('_preload_content: {}'.format(_preload_content))
